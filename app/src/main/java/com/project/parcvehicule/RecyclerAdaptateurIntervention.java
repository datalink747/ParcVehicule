 ...
 */
public class RecyclerAdaptateurIntervention extends RecyclerView.Adapter<RecyclerAdaptateurIntervention.ServicesViewHolder> {

    private Context context;
    private ArrayList<ConstParc> items;
    private ArrayList<ConstParc> list_agent=new ArrayList<ConstParc>();

    public RecyclerAdaptateurIntervention(Context context, ArrayList<ConstParc> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final ServicesViewHolder holder, final int position) {
        ...
        ConstParc intervention = items.get(position);
        holder.objectif.setText(intervention.getProbleme_intervention());
        holder.date_debut.setText(intervention.getDate_probléme());
        holder.date_fin.setText(intervention.getDate_intervention());
        ...
        public ServicesViewHolder(final Context context, final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent aff_detail =new Intent(context,Detail_intervention.class);
